...
internal sealed class PricePreset
{
    ...
    public static IReadOnlyList<PricePreset> Defaults()
    {
        return new[]
        {
            ...
            Preset("智谱/Z.AI", "GLM-4.7 FlashX", "¥", "CNY / 1M tokens", 1_000_000m, 0.50m, 0.50m, 3.00m, "智谱官方价格页"),
            Preset("智谱/Z.AI", "GLM-4.5", "¥", "CNY / 1M tokens", 1_000_000m, 0.80m, 0.80m, 2.00m, "智谱官方模型文档"),
            Preset("智谱/Z.AI", "GLM-4.5-Air", "¥", "CNY / 1M tokens", 1_000_000m, 0.80m, 0.80m, 2.00m, "智谱官方模型文档"),
            ...
            Preset("通义千问", "Qwen3 Coder Plus", "¥", "CNY / 1M tokens", 1_000_000m, 7.34m, 0.734m, 36.70m, "阿里云百炼国内价格参考"),
            Preset("通义千问", "Qwen3.7 Plus <=256K", "¥", "CNY / 1M tokens", 1_000_000m, 1.98m, 0.198m, 7.90m, "阿里云百炼全球价格折算参考"),
            Preset("通义千问", "Qwen Plus <=128K", "¥", "CNY / 1M tokens", 1_000_000m, 0.80m, 0.80m, 2.00m, "阿里云百炼国内价格参考"),
